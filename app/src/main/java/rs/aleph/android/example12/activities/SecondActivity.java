...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String kaloStr = new Integer(JeloProvider.getJeloById(position).getKlVresnost());
        kaloriskVr.setText(kaloStr);

        TextView cena= (TextView) findViewById(R.id.tv_cena_hrane);
        String cenaStr = new Double(JeloProvider.getJeloById(position).getCena());
        ...
        String cenaStr = new Float(JeloProvider.getJeloById(position).getRating());

        rbRating.setRating(cenaStr);
